...
export default function UnipinBrazil() {
                        ...
                        <div>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-blue-500 bg-blue-500 px-2 text-white rounded-full'>1</span>&nbsp;Pilih Nominal Voucher
                                        </div>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-blue-500 bg-blue-500 px-2 text-white rounded-full'>2</span>&nbsp;Pilih Pembayaran
                                        </div>
                                        <div className='mt-3'>
                                            <Accordion>
                                ...
                                <div className='border border-gray-200 rounded-xl shadow-lg bg-white xl:mt-2 lg:mt-0 md:mt-5 xs:mt-5 xss:mt-5'>
                                    <div className='xl:px-5 xl:py-5 lg:px-5 lg:py-5 md:px-5 md:py-5 sm:px-5 sm:py-5 xs:px-2 xs:py-2 mb-3'>
                                        <div className='font-bold text-lg'>
                                            <span className='border border-blue-500 bg-blue-500 px-2 text-white rounded-full'>3</span>&nbsp;Beli
                                        </div>
                                        <div>
