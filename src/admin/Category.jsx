                                ...
                                <table className="table-auto border-collapse">
                                    <thead className="bg-gray-50">
                                        <tr className="bg-gray-200 text-gray-700">
                                            ...
                                            <th className="py-2 px-4 border">pilih category</th>
...
function EditData(props) {
    ...
    const [pilih_category, setPilih_category] = useState(props.pilih_category || "");
            ...
            <Form onSubmit={handleSubmitChange}>
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Form.Select aria-label="Default select example" onChange={handleDataChange6}>
