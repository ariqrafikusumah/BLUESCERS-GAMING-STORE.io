    ...
    <>
      <div className="container xl:px-52 lg:px-32 md:px-5 xs:px-5 mt-5">
        <nav className="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-3" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li className="inline-flex items-center">
              <a href="#" className="inline-flex no-underline items-center text-sm font-medium text-gray-700 hover:text-blue-500 ">
            ...
            <li>
              <div className="flex items-center">
                ...
                <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-500 md:ml-2 "></a>
              </div>
            </li>
          </ol>
        </nav>

        <h1 className="text-3xl font-bold mb-10 mt-10 text-black">- Product Games</h1>
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">
          <a href="/admin/mobile-legend-2" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Pre Order Diamonds JJK Phase 2</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/flash-sale" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
          ...
          <a href="/admin/mobile-legend" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Diamond Fast</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-3" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Diamond Receh</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-3" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Diamond Slow</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/starlight" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Starlight Top Up</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/twilight" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Twilight</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-5" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Weekly Diamond Pass</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-6" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Pre Order Skin Jujutsu Kaisen X MLBB</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-7" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Skin Limited Edition Collector Maret 2023</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-8" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Pre Order Skin</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/mobile-legend-9" className=' no-underline'>
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Gift Skin</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/smile-one" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Smile One</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/garena-shell" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Garena Shell</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/unipin-brazil" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Unipin Brazil</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/unipin-malay" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Unipin Malay</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/youtube" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Youtube Premium</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/netflix" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
          ...
          <a href="/admin/spotify" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
          ...
          <a href="/admin/wetv" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">WeTv</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/canva" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Canva</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/vidio" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Vidio</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/bsstation" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">BS Station</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/getcontact" className=' no-underline'>
            <div className="hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Get Contact</h2>
                  <p className="text-blue-500 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
        ...
        <h1 className="text-3xl font-bold mb-10 mt-10 text-black">- Payment</h1>
            ...
            <div className=" hover:text-blue-500 hover:bg-blue-500 bg-white border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  ...
                  <p className="text-blue-500 text-lg font-bold">Edit Payment</p>
                </div>
              </div>
            </div>
          </a>
        ...
        <h1 className="text-3xl font-bold mb-10 mt-10 text-black">- Category</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <h1 className="text-3xl font-bold mb-10 mt-10 text-black">- Home Page</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
